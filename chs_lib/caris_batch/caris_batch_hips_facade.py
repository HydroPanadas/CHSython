...
def get_batch_utility() -> CarisBatchProcess:
    ...
    """
    return CarisBatchProcess(config_manager.get_caris_batch_hips())
...
def get_batch_utility_rt(logger: Optional[logging.Logger] = None) -> CarisBatchProcessRT:
    ...
    """
    return CarisBatchProcessRT(config_manager.get_caris_batch_hips(), logger=logger)
